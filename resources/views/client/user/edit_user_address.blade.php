...
@section('content')
    ...
    <div class="">
        <h2 class="text-center">EDITAR DE LA DIRECCION</h2>
    </div>
    <br>
...
<br><br>
<form action="/client/user/update-user-address/{{$user->id}}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
    @csrf
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="address1" name="address" maxlength="150" value="{{$user->address}}"
