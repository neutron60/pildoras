...
<div class="accordion" id="accordionExample">
        ...
        <div class="card-body">
            ...
            <form action="/client/purchase/store-order" method="POST" enctype="multipart/form-data"
                ...
                <div class="form-row ">
                    ...
                    <div class="ml-3 ">
                        <input type="text" maxlength="50" pattern="" class="form-control" id="shipping_address" size="60"
                ...
                <div class="form-row ">
                    ...
                    <div class="ml-3 ">
                        <input type="text" maxlength="50" pattern="" class="form-control" id="shipping_city" name="shipping_city"
                    ...
                    <div class="ml-3 ">
                        <input type="text" maxlength="50" pattern="" class="form-control" id="shipping_zip_code" size="10"
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
        <div class="card-body">
            ...
            <form action="/client/purchase/store-order" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                @csrf
                <div class="form-row ">
                    <div class="ml-3">
                        <label class="" for="nombre">empresa de envio:</label>
                ...
                <div class="form-row ">
                    ...
                    <div class="ml-3 ">
                        ...
                        <input type="hidden" name="shiping_address" value="{{$user->address}}">
                    </div>
                </div>
                ...
                <div class="form-row ">
                    ...
                    <div class="ml-3 ">
                        ...
                        <input type="hidden" name="shiping_city" value="{{$user->city}}">
                    </div>
                    <div class="ml-5">
                        <label class="" for="nombre">estado:</label>
                    </div>
                    <div class="ml-3 ">
                        ...
                        <input type="hidden" name="shiping_state" value="{{$user->state}}">
                    </div>
                    <div class="ml-5">
                        <label class="" for="nombre">Codigo postal:</label>
                    </div>
                    <div class="ml-3 ">
                        ...
                        <input type="hidden" name="shiping_zip_code" value="{{$user->zip_code}}">
                    </div>
                </div>
                <div class=" form-row ">
                    <div class="ml-3">
                        <label class="" for="nombre">
                            <p>Nota:Si no tiene direccion registrada debe primero registar su direccion o seleccionar la opcion de envio a nueva direccion</p>
                        </label>
                    </div>
                </div>
    ...
    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
        <div class="card-body">
            ...
            <form action="/client/purchase/store-order" method="POST" enctype="multipart/form-data" novalidate="">
                @csrf
                <div class="form-row ">
                    <div class="ml-3">
                        <label class="" for="nombre">empresa de envio:</label>
                ...
                <div class="form-row ">
                    ...
                    <div class="ml-3 ">
                        <input type="text" maxlength="200" pattern="" class="form-control" id="shipping_address" size="60"
                            name="shipping_address" value="{{old('shipping_address')}}">
                ...
                <div class="form-row ">
                    ...
                    <div class="ml-3 ">
                        <input type="text" maxlength="50" pattern="[A-Za-z]" class="form-control" id="shipping_zip_code" size="10"
                            name="shipping_zip_code" value="{{old('shipping_zip_code')}}">
                    </div>
                </div>
                <br>
